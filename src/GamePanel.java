...
public class GamePanel extends JPanel implements ActionListener{
    ...
    public void draw(Graphics g){
        if(running){
            ...
            g.drawString("AppelsEaten: "+ applesEaten , (SCREEN_WIDTH - metrics.stringWidth("ApplesEeaten: "+applesEaten)) / 2, g.getFont().getSize());
        }else{
            gameOver(g);
        }
    }
    ...
    public void gameOver(Graphics g){
        ...
        g.drawString("AppelsEaten: "+ applesEaten , (SCREEN_WIDTH - appleMetrics.stringWidth("ApplesEeaten: "+applesEaten)) / 2, g.getFont().getSize());
